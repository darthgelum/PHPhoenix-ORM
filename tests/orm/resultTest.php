...
class ORM_Result_Test extends PHPUnit_Framework_TestCase
{
	...
	protected function setUp()
	{
		...
		$this->phoenix->db = $this->getMockBuilder('\PHPhoenix\DB')
				->disableOriginalConstructor()
				->getMock();
		$this->phoenix->orm = new \PHPhoenix\ORM($this->phoenix);
		$this->object = new \PHPhoenix\ORM\Result($this->phoenix,'stub', $this->stub);
	}
	...
	public function test_with()
	{
		...
		$this->object = new \PHPhoenix\ORM\Result($this->phoenix, 'Stub', $this->stub, array(
	...
	public function test_withArrayData()
	{
		...
		$this->object = new \PHPhoenix\ORM\Result($this->phoenix,'Stub', $this->stub, array(
			'tester' => array('model' => $this->phoenix->orm->get('Stub')),
			'tester.another' => array('model' => $this->phoenix->orm->get('Stub'))
		));
		$arr = $this->object->as_array(true);
		foreach (array('Trixie', 'Tinkerbell') as $key => $name)
		{
