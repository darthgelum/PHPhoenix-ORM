...
class Result implements \Iterator
{
	 ...
	 * @return void
	 */
	public function __construct($phoenix, $model, $dbresult, $with = array())
	{
	 ...
	 * @return \PHPhoenix\ORM\Model Model instance initialized with item data
	 */
	public function build_model($data) {
		
		$model = $this->phoenix->orm->get($this->_model);
		...
		foreach ($this->_with as $rel)
		{
			...
			$rel_model = $this->phoenix->orm->get($rel['model']->model_name);
	 ...
	 *
	 * @return \PHPhoenix\ORM\Model Model of the current row of the result set
	 */
	...
	public function as_array($rows = false)
	{
		...
		$arr = array();
		$model = $model = $this->phoenix->orm->get($this->_model);
